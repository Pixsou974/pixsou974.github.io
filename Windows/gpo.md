...
* <u>Configuration utilisateur > Strategies > Modeles d'administration > Bureau > Papier Peint du Bureau</u> (Mettre le chemin du fond d'ecran)

## GPO  Configuration WSUS

**WSUS - Communs :**
* <u>Configuration Ordinateur > Strategies > Parametres d'administration > Composants Windows > Windows Update</u>
...
## GPO Mot de Passe
* <u>Configuration Ordinateur > Strategies > Parametres Windows > Parametres de securité > Strategie de Compte > Strategie de Mot de Passe</u>
...
> Pour verifier quel strategie de mot de passe est appliqué sur le PC il faut faire la commande `net accounts` en administrateur# GPO Windows Server
